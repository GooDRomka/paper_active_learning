...
# LSTM-CRF
(cd ../ && ./tagger.py --corpus=CoNLL_en --train_data=data/english/test.txt --test_data=data/english/test.txt --dev_data=data/english/test.txt --decoding=CRF --epochs=1:1e-3 --name=test_run)
