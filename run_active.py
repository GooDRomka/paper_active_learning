...
# elif exp_type == 10:
#     # self learning rand
#     params = [[STRATEGY.RAND, STRATEGY.SELF, 800, 8000, 0],
#           [STRATEGY.RAND, STRATEGY.SELF, 1000, 8000,  0],
#           [STRATEGY.RAND, STRATEGY.SELF, 2000, 8000,  0],
#           [STRATEGY.RAND, STRATEGY.SELF, 3000, 8000,  0],
#           [STRATEGY.RAND, STRATEGY.SELF, 2400, 8000,  0],
#           [STRATEGY.RAND, STRATEGY.SELF, 4000, 8000,  0],
#           [STRATEGY.RAND, STRATEGY.SELF, 1200, 8000,  0],
#           [STRATEGY.RAND, STRATEGY.SELF, 1600, 8000,  0],
#           ]
#     for i in range(5):
#         for param in params:
#             for j in range(2):
